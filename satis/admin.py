...
class SiparisSatiriAdmin(ImportExportModelAdmin):
    ...
    list_filter = [
        'siparis__durum',
        'siparis__odeme_tipi',
        ('siparis__tarih', PastDateRangeFilter),
    ]
    ...
    def get_readonly_fields(self, request, obj=None):
        local_many_to_many_list = [field.name for field in self.opts.local_many_to_many]
        readonly_fields = list(
            set([field.name for field in self.opts.local_fields] + local_many_to_many_list)
        )
